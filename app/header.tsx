                                ...
                                <div className="absolute left-0 mt-5 w-[25rem] bg-white rounded-lg shadow-lg py-2 px-4 grid grid-cols-2 ">
                                    {items.map((item, index) => (
                                        <a
                                            key={index}
                                            href={item.href}
                                            className="block px-3 py-2 text-black hover:bg-gray-100   rounded-lg"
                                        >
                                            {item.name}
                                        </a>
                                    ))}
                ...
                <div className="flex flex-col space-y-4 p-6">
                    {Object.entries(dropdownItems).map(([key, items]) => (
                        <div key={key} className=" pt-4">
                            <button
                                className="w-full text-left text-black flex items-center justify-between uppercase hover:text-[#5699AD]"
